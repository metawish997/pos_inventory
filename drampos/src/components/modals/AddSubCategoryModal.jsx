...
import { createSubCategory, getCategories, uploadImage } from '../../services/inventoryService';
...
const AddSubCategoryModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Sub Category" maxWidth="600px">
