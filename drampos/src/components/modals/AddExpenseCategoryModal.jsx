...
const AddExpenseCategoryModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Expense Category" maxWidth="500px">
      <form onSubmit={(e) => e.preventDefault()} className={styles.form}>
        ...
        <div className={styles.footerActions}>
          ...
          <button type="submit" className={styles.btnSubmit}>Add Expense Category</button>
        </div>
      </form>
    </Modal>
  );
