...
import { createQuotation } from '../../services/salesService';
            ...
            <input 
              ...
              onChange={(e) => {
                ...
                const match = customers.find(c =>
                  `${c.firstName} ${c.lastName}`.trim().toLowerCase() === val.toLowerCase() ||
              ...
              list="quot-customer-suggestions"
              required
            />
            <datalist id="quot-customer-suggestions">
              {customers.map(c => (
