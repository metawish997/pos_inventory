...
const EditCouponModal = ({ isOpen, onClose }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Coupon" maxWidth="800px">
      <form onSubmit={(e) => e.preventDefault()} className={styles.form}>
        ...
        <div style={{display: 'flex', gap: '1.5rem', marginBottom: '1.5rem'}}>
          <div style={{flex: 1}}>
            ...
            <input type="text" className={styles.input} defaultValue="New Year Blast" />
          </div>
          <div style={{flex: 1}}>
            ...
            <input type="text" className={styles.input} defaultValue="NEWYEAR30" />
          </div>
        </div>
        ...
        <div style={{display: 'flex', gap: '1.5rem', marginBottom: '1.5rem'}}>
          <div style={{flex: 1}}>
            ...
            <select className={styles.select} defaultValue="Percentage">
          ...
          <div style={{flex: 1}}>
            ...
            <input type="text" className={styles.input} defaultValue="30" />
          </div>
        </div>

        <div className={styles.formGroup}>
          <label>Limit <span className={styles.required}>*</span></label>
          <input type="text" className={styles.input} defaultValue="01" />
        ...
        <div style={{display: 'flex', gap: '1.5rem', marginBottom: '1.5rem'}}>
          <div style={{flex: 1}}>
            ...
            <input type="text" className={styles.input} defaultValue="31 Dec 2024" />
          </div>
          <div style={{flex: 1}}>
            ...
            <input type="text" className={styles.input} defaultValue="04 Jan 2026" />
          </div>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <div style={{border: '1px solid #E5E7EB', borderRadius: '4px', overflow: 'hidden'}}>
            ...
            <textarea style={{width: '100%', border: 'none', padding: '1rem', minHeight: '100px', outline: 'none', resize: 'vertical'}} defaultValue="30% off on New Year"></textarea>
          </div>
