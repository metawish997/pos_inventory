...
const AddPurchaseReturnModal = ({ isOpen, onClose }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add Purchase Return" maxWidth="900px">
      <form onSubmit={(e) => e.preventDefault()} className={styles.form}>
          ...
          <table style={{width: '100%', minWidth: '700px', borderCollapse: 'collapse', fontSize: '0.875rem', textAlign: 'left'}}>
            <thead>
              <tr style={{borderBottom: '1px solid #E5E7EB'}}>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Image</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Date</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Supplier</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Reference</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Status</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Total ($)</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Paid ($)</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Due ($)</th>
                <th style={{padding: '0.75rem', fontWeight: 600, color: '#374151'}}>Payment Status</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td colSpan="9" style={{padding: '2rem', textAlign: 'center', color: '#6B7280'}}>No products added</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className={styles.formGroup}>
          ...
          <div style={{border: '1px solid #E5E7EB', borderRadius: '4px', overflow: 'hidden'}}>
            ...
            <textarea style={{width: '100%', border: 'none', padding: '1rem', minHeight: '100px', outline: 'none', resize: 'vertical'}} defaultValue="Type your message"></textarea>
          </div>
