    ...
    <DashboardLayout>
      ...
      <Card className={styles.tableCard}>
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', borderBottom: '1px solid #F3F4F6'}}>
          <h2 style={{fontSize: '1rem', fontWeight: 600, color: '#1B2850', margin: 0}}>Best Sellers</h2>
          ...
          <table className={styles.productTable}>
            ...
            <tbody>
              {[
                ...
                { sku: 'PT009', name: 'Gaming Chair', brand: 'Arlime', category: 'Furniture', sold: '10', amount: '$2000', instock: '410', img: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=50' },
                { sku: 'PT010', name: 'Borealis Backpack', brand: 'The North Face', category: 'Bags', sold: '20', amount: '$900', instock: '550', img: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=50' },
              ].map((item, i) => (
                <tr key={i}>
