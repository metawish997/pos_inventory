      ...
      <Card className={styles.tableCard}>
        ...
        <div className={styles.tableResponsive}>
          <table className={styles.productTable}>
            ...
            <tbody>
              {[
                { sku: 'PT001', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Lenovo IdeaPad 3', total: '98', alert: '79', img: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=50' },
                { sku: 'PT002', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Beats Pro', total: '156', alert: '66', img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=50' },
                { sku: 'PT003', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Nike Jordan', total: '89', alert: '69', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=50' },
                { sku: 'PT004', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Apple Series 5 Watch', total: '569', alert: '68', img: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=50' },
                { sku: 'PT005', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Amazon Echo Dot', total: '548', alert: '33', img: 'https://images.unsplash.com/photo-1518444065439-e931662788e2?w=50' },
                { sku: 'PT006', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Sanford Chair Sofa', total: '456', alert: '16', img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=50' },
                { sku: 'PT007', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Red Premium Satchel', total: '178', alert: '86', img: 'https://images.unsplash.com/photo-1584916201218-f4242ceb4809?w=50' },
                { sku: 'PT008', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Iphone 14 Pro', total: '1768', alert: '33', img: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=50' },
                { sku: 'PT009', serial: 'LNV-IP3-8GB-256SSD-BL', name: 'Gaming Chair', total: '568', alert: '528', img: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=50' },
              ].map((item, i) => (
                <tr key={i}>
                  ...
                  <td style={{color: '#6B7280'}}>{item.alert}</td>
                </tr>
              ))}
            </tbody>
          </table>
