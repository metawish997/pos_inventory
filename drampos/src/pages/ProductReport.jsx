    ...
    <DashboardLayout>
      <div className={styles.pageHeader}>
        <div>
          ...
          <h1 className={styles.title}>Product Report</h1>
      ...
      <Card className={styles.tableCard}>
        <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '1.5rem', borderBottom: '1px solid #F3F4F6'}}>
          <h2 style={{fontSize: '1rem', fontWeight: 600, color: '#1B2850', margin: 0}}>Product Report</h2>
        ...
        <div className={styles.tableResponsive}>
          <table className={styles.productTable}>
            ...
            <tbody>
              {[
                { sku: 'PT001', name: 'Lenovo IdeaPad 3', category: 'Computers', brand: 'Lenovo', qty: '100', price: '$600', ordered: '5000', revenue: '$787258', img: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=50' },
                { sku: 'PT002', name: 'Beats Pro', category: 'Electronics', brand: 'Beats', qty: '140', price: '$160', ordered: '4860', revenue: '$689788', img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=50' },
                { sku: 'PT003', name: 'Nike Jordan', category: 'Shoe', brand: 'Nike', qty: '300', price: '$110', ordered: '40', revenue: '$7757', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=50' },
                { sku: 'PT004', name: 'Apple Series 5 Watch', category: 'Electronics', brand: 'Apple', qty: '450', price: '$120', ordered: '9642', revenue: '$7555', img: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=50' },
                { sku: 'PT005', name: 'Amazon Echo Dot', category: 'Electronics', brand: 'Amazon', qty: '320', price: '$80', ordered: '5464', revenue: '$39698', img: 'https://images.unsplash.com/photo-1518444065439-e931662788e2?w=50' },
                { sku: 'PT006', name: 'Sanford Chair Sofa', category: 'Furniture', brand: 'Modern Wave', qty: '650', price: '$320', ordered: '158', revenue: '$748', img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=50' },
                { sku: 'PT007', name: 'Red Premium Satchel', category: 'Bags', brand: 'Dior', qty: '700', price: '$60', ordered: '7845', revenue: '$7985', img: 'https://images.unsplash.com/photo-1584916201218-f4242ceb4809?w=50' },
                { sku: 'PT008', name: 'Iphone 14 Pro', category: 'Phone', brand: 'Apple', qty: '630', price: '$540', ordered: '540', revenue: '$8769798', img: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=50' },
                { sku: 'PT009', name: 'Gaming Chair', category: 'Furniture', brand: 'Arlime', qty: '410', price: '$200', ordered: '200', revenue: '$788979', img: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=50' },
              ].map((item, i) => (
                <tr key={i}>
                  ...
                  <td style={{color: '#6B7280'}}>{item.ordered}</td>
                  <td style={{color: '#6B7280'}}>{item.revenue}</td>
                </tr>
              ))}
            </tbody>
          </table>
