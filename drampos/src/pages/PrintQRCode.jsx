  ...
  return (
    <DashboardLayout>
      <div className={styles.pageHeader}>
        <div>
          <h1 className={styles.title}>Print QR Code</h1>
          <p className={styles.subtitle}>Generate and Print Product QR Codes</p>
        </div>
          ...
          <table style={{width: '100%', borderCollapse: 'collapse', textAlign: 'left'}}>
            <thead>
              <tr style={{backgroundColor: '#F3F4F6', color: '#1B2850', fontSize: '0.875rem'}}>
                ...
                <th style={{padding: '0.75rem 1rem', fontWeight: 600}}>Product Code</th>
            ...
            <tbody>
              {selectedItems.length === 0 ? (
                <tr>
                  <td colSpan="6" style={{textAlign: 'center', padding: '2rem', color: '#6B7280'}}>No products added to QR code print queue</td>
                </tr>
              ) : (
