    ...
    <DashboardLayout>
      <div className={styles.pageHeader}>
        <div>
          ...
          <p className={styles.subtitle}>View Reports of Stock History</p>
        </div>
      ...
      <Card className={styles.tableCard}>
        ...
        <div className={styles.tableResponsive}>
          <table className={styles.productTable}>
            ...
            <tbody>
              {[
                { sku: 'PT001', name: 'Lenovo IdeaPad 3', initial: '6000', added: '100', sold: '100', defective: '100', final: '100', img: 'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?w=50' },
                { sku: 'PT002', name: 'Beats Pro', initial: '10', added: '140', sold: '140', defective: '140', final: '140', img: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=50' },
                { sku: 'PT003', name: 'Nike Jordan', initial: '08', added: '300', sold: '300', defective: '300', final: '300', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=50' },
                { sku: 'PT004', name: 'Apple Series 5 Watch', initial: '10', added: '450', sold: '450', defective: '450', final: '450', img: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=50' },
                { sku: 'PT005', name: 'Amazon Echo Dot', initial: '05', added: '320', sold: '320', defective: '320', final: '320', img: 'https://images.unsplash.com/photo-1518444065439-e931662788e2?w=50' },
                { sku: 'PT006', name: 'Sanford Chair Sofa', initial: '07', added: '650', sold: '650', defective: '650', final: '650', img: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=50' },
                { sku: 'PT007', name: 'Red Premium Satchel', initial: '15', added: '700', sold: '700', defective: '700', final: '700', img: 'https://images.unsplash.com/photo-1584916201218-f4242ceb4809?w=50' },
                { sku: 'PT008', name: 'Iphone 14 Pro', initial: '12', added: '630', sold: '630', defective: '630', final: '630', img: 'https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=50' },
                { sku: 'PT009', name: 'Gaming Chair', initial: '10', added: '410', sold: '410', defective: '410', final: '410', img: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?w=50' },
              ].map((item, i) => (
                <tr key={i}>
                  ...
                  <td style={{color: '#6B7280'}}>{item.initial}</td>
                  <td style={{color: '#6B7280'}}>{item.added}</td>
                  <td style={{color: '#6B7280'}}>{item.sold}</td>
                  <td style={{color: '#6B7280'}}>{item.defective}</td>
                  <td style={{color: '#6B7280'}}>{item.final}</td>
                </tr>
              ))}
            </tbody>
          </table>
